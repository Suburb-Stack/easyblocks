...
// Widget's component
import { WidgetComponentProps } from "@suburb-stack/core";
...
<pre class="language-tsx"><code class="lang-tsx"><strong>import { ExternalData } from '@suburb-stack/core';
</strong><strong>
...
To build a simple usable widget component, Easyblocks comes with `SimplePicker` component that can be imported from `@suburb-stack/design-system` package. It comes with built-in support for:
...
```typescript
import type { Config } from "@suburb-stack/core";
