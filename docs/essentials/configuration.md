...
```typescript
import type { Config, EasyblocksBackend } from "@suburb-stack/core";
...
<pre class="language-typescript"><code class="lang-typescript">import type { Config } from '@suburb-stack/core';
